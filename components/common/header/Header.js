    ...
    return (
      <div>
        <div style={{ backgroundColor: "#f5f7fa" }}>
          <div className="header-upper-block container">
            <div className="header-upper-left">
              ...
              <div className="header-upper-choose-clinic">
                <p>Выбрать клинику</p>
            ...
            <div className="header-upper-right">
              <button className="btn btn-white header-btn">
                Отправить МРТ
              </button>
              <button className="btn btn-blue header-btn">
                Школа пациентов{" "}
                <img src="https://static.tildacdn.com/tild3931-6638-4432-b561-383564633534/question.svg" />
              </button>
              <div>Пн-Вс: 8:00-20:00</div>
              <a href="tel: +79584055327">
                {" "}
                <img src="https://static.tildacdn.com/tild6533-3431-4166-b465-336335663033/telephone2.svg" />{" "}
                8 (958) 405-53-27
              </a>
            </div>
          </div>
        </div>
        <div className="header-blue-adap-block">
          Лечим грыжу и другие причины боли в спине
        </div>
        <div className="header-lower-block container">
          <div className="header-lower-left">
            <Link href="/">
              <img src="https://static.tildacdn.com/tild6136-3038-4233-b233-666434353033/CTE_Symbol.svg" />
            </Link>
          </div>
          <div className="header-lower-right">
            <div className="header-lower-services">
              <p>Услуги</p>
            ...
            <img
              ...
              width="18px"
              src="https://static.tildacdn.com/tild6664-6139-4133-b933-323364376664/loupe1.svg"
            />
          </div>
          <div className="header-lower-right-adap">
            ...
            <img
              width="32px"
              src="https://static.tildacdn.com/tild6533-3431-4166-b465-336335663033/telephone2.svg"
            />
            <img
              width="32px"
              src="https://static.tildacdn.com/tild3465-6139-4532-a265-666162346131/icon-address.png"
            />
            <div
            ...
            >
              <svg
                className={
                  "ham hamRotate ham4 " + (activeBurger ? " active" : "")
                }
                viewBox="0 0 100 100"
                width="50"
              >
        ...
        <div
          ...
          className={
            "header-search-block-wrapper " + (activeSearch ? "active" : "")
          }
        >
          <div
            onClick={(e) => {
          ...
          >
            <div className="header-search-input">
              <svg
                ...
                className="t985__search-icon t-search-widget__search-icon"
                width="30"
                height="30"
                viewBox="0 0 30 30"
                fill="none"
              ...
              >
                {" "}
                <path
                  d="M1.00004 10.9659L10.9999 0.999962"
                  stroke="#565656"
                ></path>{" "}
                <path
                  d="M10.9883 10.9986L1.00214 1.02924"
                  stroke="#565656"
                ></path>{" "}
              </svg>
            </div>
            ...
            >
              {" "}
              <path
                d="M0.754014 27.4806L27.0009 1.32294"
                stroke="black"
              ></path>{" "}
        ...
        <div
          ...
          className={
            "header-burger-modal-wrapper " + (activeBurger ? "active" : "")
          }
        >
          <div
            className="header-burger-modal"
            onClick={(e) => {
              e.stopPropagation();
            }}
          >
            <div>
              ...
              >
                ...
                ></path>{" "}
                <path
                  d="M26.9688 27.5665L0.757956 1.39984"
                  stroke="black"
                ></path>{" "}
              </svg>
            </div>
            <div>ГЛАВНАЯ</div>
            <div className="header-upper-choose-clinic header-burger-clinic">
              <p>ВЫБРАТЬ КЛИНИКУ</p>
              <div className="header-clinics-wrapper">
            ...
            <div style={{ position: "absolute", bottom: "10px" }}>
              ...
              <div className="header-burger-modal-svg">
                ...
                >
                  {" "}
                  <path
                    d="M47.761,24c0,13.121-10.638,23.76-23.758,23.76C10.877,47.76,0.239,37.121,0.239,24c0-13.124,10.638-23.76,23.764-23.76
                ...
                >
                  ...
                  <path
                    style={{ fill: "#0e7496" }}
                    d="M-431,257.013c13.248,0,23.987,10.74,23.987,23.987s-10.74,23.987-23.987,23.987s-23.987-10.74-23.987-23.987
